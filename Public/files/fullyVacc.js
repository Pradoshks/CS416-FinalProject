function fullyVacc(svg, wordAllData, selectedCountry, selectedvalue){
...
console.log(dataFilter)
  ...
  const yValue = d => d.new_vaccinations;
  const yAxisLabel = 'No. Of People Fully Vaccinated';
  ...
  d3.select(".leftTitle")
  .html("Country : " + selectedCountry + "</br>" + "Total Vaccinations : "+d3.format(",")(selectedvalue))
