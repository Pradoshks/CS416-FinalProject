function casesCumul(svg, usAllData, countries, countryName, data, data_cases_mil) {
  ...
  let text1 = `Coronavirus disease (COVID-19) is an infectious disease caused by a newly discovered coronavirus. On March 11, 2020, the WHO declared COVID-19 a global pandemic, its first such designation since declaring H1N1 influenza a pandemic in 2009.
  It has devastaed all countries over a period of more than a year now. `

  text2 = 'World has seen 195,079,027 (195M) infections so far.'
  ...
  function createChart(d, i) {
    ...
    createUSChart(svg, usAllData, countryName[i.id], total_cases)
  }
