function createCumCaseMil(svg, wordAllData, selectedCountry, selectedvalue){
...
console.log(dataFilter)
  ...
  const yValue = d => d.new_cases_per_million;
  ...
  d3.select(".leftTitle")
  .html("Country : " + selectedCountry + "</br>" + "Total Cases : "+d3.format(",.0f")(selectedvalue))
  ...
  const title = "Case Growth Over Time Per Million - " + selectedCountry
  g.append('text')
    .attr('class', 'title')
    .attr('y', -25)
    .attr('x', 210)
