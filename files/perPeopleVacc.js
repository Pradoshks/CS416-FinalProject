function perPeopleVacc(svg, usAllData, countries, countryName, data_rel_pop_vaccine, data) {
  height = 600;
  width = 980;

console.log(usAllData)
  ...
  g.append('rect')
    ...
    .on('click', d=>peopleVacc(svg, usAllData, countries, countryName, data, data_rel_pop_vaccine))
  ...
  function createChart(d, i) {
    people_vaccinated = data_rel_pop_vaccine.get(countryName[i.id]) || 0
    perPeopFullyVac(svg,usAllData,countryName[i.id], people_vaccinated)
